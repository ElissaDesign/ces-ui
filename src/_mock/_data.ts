...
export const _myAccount = {
  displayName: user? `${user?.lastName} ${user?.firstName}`:'Jaydon Frankie',
...
export const _posts = [...Array(23)].map((_, index) => {return {
  id: _id(index),
...
export const _tasks = Array.from({ length: 5 }, (_, index) => {return {
  id: _id(index),
