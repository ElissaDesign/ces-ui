...
const rootStyles = (): CSSObject => {return {
  display: 'flex',
  flex: '1 1 auto',
  alignItems: 'center',
  padding: '10vh 15px 0',
...
const contentStyles = (): CSSObject => {return {
  gap: 24,
  padding: 20,
  width: '100%',
  maxWidth: 960,
...
const titleStyles = (theme: Theme): CSSObject => {return {
  margin: 0,
  lineHeight: 1.2,
...
const messageStyles = (theme: Theme): CSSObject => {return {
  margin: 0,
  lineHeight: 1.5,
  padding: '12px 16px',
  whiteSpace: 'pre-wrap',
...
const detailsStyles = (): CSSObject => {return {
  margin: 0,
  padding: 16,
  lineHeight: 1.5,
  overflow: 'auto',
...
const filePathStyles = (): CSSObject => {return {
  marginTop: 0,
